...
class ServiceRepository implements IServiceRepository {
  ...
  @override
  Future<List<Service>> getServicesByBabysitterId(int id, bool isFinished, String? paymentMethod, DateTime? initialDate, DateTime? finalDate, String? statusService) async {
    try {
      final response = await _supabase
        .from('service')
        .select('*, babysitter:babysitter(*), parent:parent(*)')
  ...
  @override
  Future<List<Service>> getServicesByParentId(int id, bool isFinished, String? paymentMethod, DateTime? initialDate, DateTime? finalDate, String? statusService) async {
    try {
      final response = await _supabase
        .from('service')
        .select('*, babysitter:babysitter(*), parent:parent(*)')
